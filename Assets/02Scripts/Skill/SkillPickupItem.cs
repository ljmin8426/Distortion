...
{
    [SerializeField] private SkillItemSO skillData;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (e.GetType() == skillData.skillPrefab.GetComponent<SkillBase>().GetType())
            {
        ...
        // 스킬 생성 및 추가
        var skillObj = Instantiate(skillData.skillPrefab, other.transform);
